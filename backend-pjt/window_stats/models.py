...
class WindowStats(models.Model):
    ...
    end_price = models.DecimalField(max_digits=20, decimal_places=4, verbose_name="윈도우 시작가")
    change_rate = models.FloatField(verbose_name='변동률')
    status = models.CharField(max_length=15, verbose_name='상태')
    created_at = models.DateTimeField(auto_now_add=True)

    class Meta:
        db_table = 'window_stats'
        verbose_name = '윈도우 집계 로그'
        verbose_name_plural = '윈도우 집계 로그 목록'